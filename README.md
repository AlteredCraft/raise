# RAISE
**R**esponsible **AI** assisted **S**oftware **E**ngineering
...
### 1. Ideate on the Manifesto (we are here)

[RAISE manifesto](./raise-manifesto.md)

### 2. RAISE manifest

Research and collect a set of tools and policies with exemplify the RAISE manifesto

### 3. RAISE Lab

Collaborate of tools with assist developers in aligning to the RAISE Manifesto
